...
class DataValidation:
    ...
    def validate_number_of_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            validate_results=True if (len(dataframe.columns)==number_of_columns) else False
    ...
    def initiate_data_validation(self)->DataIngestionArtifact:
        try:
            ...
            ##read the data from t rain a nd test
            ...
            data_validation_artifact=DataValidationArtifact(
                ...
                drift_report_file_papth=self.data_validation_config.drift_report_file_path,
            )

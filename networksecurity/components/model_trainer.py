...
import mlflow
import dagshub
dagshub.init(repo_owner='Ahamad-ai', repo_name='networksecurity', mlflow=True)
...
class ModelTrainer:
    ...
    '''
    train_model is doing:
    train model > hyperparameter tuning > evaluation > model trainer artifact
    '''    
